    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-sm text-gray-600">Add a new book to your library collection</p>
            </div>
            ...
            <!-- Create Form -->
            <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-sm rounded-lg overflow-hidden">
                @csrf
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="cover" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            ...
                                            <input id="cover" name="cover" type="file" class="sr-only" required accept="image/*">
                                        </label>
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="pdf" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                            ...
                                            <input id="pdf" name="pdf" type="file" class="sr-only" required accept="application/pdf">
                                        </label>
                                        <p class="pl-1">or drag and drop</p>
                                    </div>
